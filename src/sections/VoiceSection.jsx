...
const VoiceSections = () => {
  ...
  return (
    <section className="flex md:flex-row flex-col justify-center items-center py-12 md:space-x-24">
      ...
      <div className="flex flex-col items-center" data-aos="zoom-in">
        ...
        {/* Audio Controls */}
        <div
          className="z-20 h-[8rem] bg-gradient-to-b from-[#130D2C] to-[#271A5E] text-white rounded-lg p-4 md:w-[24vw] w-[18rem] flex flex-col items-center justify-center"
          data-aos="fade-right"
        >
          <p className="poppins-bold md:text-lg text-xl md:mb-2 mb-0.5">
            Gustixa - Lemon Tree
          </p>
          <p className="md:text-sm text-base poppins-bold">Gustixa</p>
      ...
      <div className="md:mt-0 mt-10 mx-5 md:mx-0" data-aos="fade-left">
        <div className="space-y-6">
          {/* Item 1 */}
          <div className="flex items-center space-x-4">
            <img src={IconImage} alt="Icon" className="h-[8rem]" />
            <p className="plus-jakarta-sans-bold text-white text-lg pr-3 md:pr-0">
